  ...
  Markdown: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 4V20H22V4H2Z M17.25 13V8H15.75V13H14L16.5 15.5L19 13H17.25Z M6.5 11L9 12.875L11.5 11V15.5H13V8L9 11L5 8V15.5H6.5V11Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  Heading1: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM3 20V4H4.5V11H12.5V4H14V20H12.5V12.5H4.5V20H3ZM20 20H18.5V13H17V12L20 11V20Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  Italic: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM18 4H10V5.5H13.5L9 18.5H6V20H14V18.5H10.5L15 5.5H18V4Z"
        fill="currentColor"
      />
    ) : (
  ...
  Underline: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM8.5 5H7V12C7 14.7614 9.23858 17 12 17C14.7614 17 17 14.7614 17 12V5H15.5V12C15.5 13.933 13.933 15.5 12 15.5C10.067 15.5 8.5 13.933 8.5 12V5Z M5 18.5V20H19V18.5H5Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  Strike: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM6.75 8.25C6.75 5.90279 8.65279 4 11 4H12.75C14.6622 4 16.2794 5.26283 16.8132 7H15.2001C14.745 6.10958 13.8187 5.5 12.75 5.5H11C9.48122 5.5 8.25 6.73122 8.25 8.25C8.25 9.76878 9.48122 11 11 11H20V12.5H4V11H7.75952C7.12987 10.2588 6.75 9.29875 6.75 8.25Z M14.8714 14H16.6241C16.8656 14.5337 17 15.1261 17 15.75C17 18.0972 15.0972 20 12.75 20H11C9.08782 20 7.47058 18.7372 6.9368 17H8.54985C9.00503 17.8904 9.93133 18.5 11 18.5H12.75C14.2688 18.5 15.5 17.2688 15.5 15.75C15.5 15.0852 15.2641 14.4755 14.8714 14Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  Code: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM8.30334 8.82067L7.24268 7.76001L3.00004 12.0027L7.24268 16.2453L8.30334 15.1846L5.12136 12.0027L8.30334 8.82067Z M15.6993 8.82067L16.76 7.76001L21.0027 12.0027L16.76 16.2453L15.6993 15.1846L18.8813 12.0027L15.6993 8.82067Z M12.5 6L10 18H11.5L14 6H12.5Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  BlockCode: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM10 3H7C5.34315 3 4 4.34315 4 6V10C4 10.5523 3.55228 11 3 11H2V12.5H3C3.55228 12.5 4 12.9477 4 13.5V17.5C4 19.1569 5.34315 20.5 7 20.5H10V19H7C6.17157 19 5.5 18.3284 5.5 17.5V13.5C5.5 12.8186 5.22742 12.2009 4.78536 11.75C5.22742 11.2991 5.5 10.6814 5.5 10V6C5.5 5.17157 6.17157 4.5 7 4.5H10V3ZM14 3H17C18.6569 3 20 4.34315 20 6V10C20 10.5523 20.4477 11 21 11H22V12.5H21C20.4477 12.5 20 12.9477 20 13.5V17.5C20 19.1569 18.6569 20.5 17 20.5H14V19H17C17.8284 19 18.5 18.3284 18.5 17.5V13.5C18.5 12.8186 18.7726 12.2009 19.2146 11.75C18.7726 11.2991 18.5 10.6814 18.5 10V6C18.5 5.17157 17.8284 4.5 17 4.5H14V3Z"
        fill="currentColor"
      />
    ) : (
      <>
        ...
        />
        <path
          d="M14 3H17C18.6569 3 20 4.34315 20 6V10C20 10.5523 20.4477 11 21 11H22V12.5H21C20.4477 12.5 20 12.9477 20 13.5V17.5C20 19.1569 18.6569 20.5 17 20.5H14V19H17C17.8284 19 18.5 18.3284 18.5 17.5V13.5C18.5 12.8186 18.7726 12.2009 19.2146 11.75C18.7726 11.2991 18.5 10.6814 18.5 10V6C18.5 5.17157 17.8284 4.5 17 4.5H14V3Z"
          fill="currentColor"
        />
      </>
    ),
  ...
  BlockQuote: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM3 20H11V12H4.5V11C4.5 9.067 6.067 7.5 8 7.5H11V6H8C5.23858 6 3 8.23858 3 11V20ZM9.5 13.5H4.5V18.5H9.5V13.5ZM21 6H18C15.2386 6 13 8.23858 13 11V20H21V12H14.5V11C14.5 9.067 16.067 7.5 18 7.5H21V6ZM19.5 13.5H14.5V18.5H19.5V13.5Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  OrderList: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM8 5H22V6.5H8V5ZM8 11H22V12.5H8V11ZM8 17.5H22V19H8V17.5ZM4 11H3V5.55556H2V4.77778L4 4V11ZM6 20V18.8333H3.6L5.20573 17.012C5.71827 16.4307 6 15.6902 6 14.9245C6 13.8617 5.10355 13 4.01028 13C2.90571 13 2 13.8706 2 14.9444V15.3333H3.2V14.9444C3.2 14.5149 3.55817 14.1667 4 14.1667C4.44183 14.1667 4.8 14.5149 4.8 14.9444V15.1377C4.8 15.5145 4.65933 15.8785 4.40412 16.1621L2 18.8333V20H6Z"
        fill="currentColor"
      />
    ) : (
      <>
  ...
  UnorderList: (filled) =>
    filled ? (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4 0H20C22 0,24 2,24 4V20C24 22,22 24,20 24H4C2 24,0 22,0 20V4C0 2,2 0,4 0ZM8 5H22V6.5H8V5ZM8 11H22V12.5H8V11ZM8 17.5H22V19H8V17.5ZM3 5H5V7H3ZM3 11H5V13H3ZM3 17H5V19H3Z"
        fill="currentColor"
      />
    ) : (
      <>
